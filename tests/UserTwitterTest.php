...
class UserTwitterTest extends AbstractTest {
	...
	function testCantAddTwicetoDifferentAccounts() {
		...
		$user1->addTwitter("Test",  "jarofgreen");
		$this->setExpectedException("UserTwitterAlreadyExistsException");
		$user2->addTwitter("Test", "jarofgreen");		
	}
