...
class UserTelephoneTest extends AbstractTest {
	...
	function testCantAddTwicetoDifferentAccounts() {
		...
		$user1->addTelephone("Test", 1, "7764970336");
		$this->setExpectedException("UserTelephoneAlreadyExistsException");
		$user2->addTelephone("Test", 1, "7764970336");
	}
