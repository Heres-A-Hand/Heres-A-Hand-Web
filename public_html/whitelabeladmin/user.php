...
$user = UserAccount::findByIDinWhiteLabel($_GET['id'], $whiteLabel);
if (!$user) die('Not Found, or you don\'t have access! Please go back.');
...
$s->display('whitelabeladmin/user.htm');
