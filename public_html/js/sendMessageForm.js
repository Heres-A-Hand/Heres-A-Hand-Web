...
$(document).ready(function(){
	...
	$('#SendMessageHideFrom').hide();
	$('#SendMessageHideFromLink').show();
	$('#SendMessageHideFromLink').click(function() {
		$('#SendMessageHideFrom').show();
		$('#SendMessageHideFromLink').hide();
	});

	$('#SendMessageCalendarLink').show();
	$('#SendMessageCalendarLink').click(function() {
		$('#SendMessageCalendar').show();
		$('#SendMessageCalendarLink').hide();
		$('#SendMessageCalendarHiddenField').val('1');
	});
